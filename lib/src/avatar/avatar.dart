...
class Avatar extends SvgAvatarPiece with _$Avatar {
  ...
  static const defaultAvatar = Avatar(
    ...
    eyes: Eyes(eyesType: EyesType.basic),
    mouth: Mouth(mouthType: MouthType.basic),
    accessories: Accessories(accessoryType: AccessoryType.blank),
    facialHair: FacialHair(
      facialHairType: FacialHairType.blank,
      facialHairColor: FacialHairColor.black,
    ),
    hairStyle: HairStyle(
      hairStyleType: HairStyleType.shortHairFlat,
      hairColor: HairColor.black,
    ),
    skin: Skin(skinColor: SkinColor.pale),
    cloth: Cloth(
      clothType: ClothType.hoodie,
      clothColor: ClothColor.blue02,
    ),
  );
